...
class AusrustungView extends StatefulWidget {
  final AnimationController animationController;
  final Animation animation;

  const AusrustungView({Key key, this.animationController, this.animation})
      : super(key: key);

  @override
  _AusrustungViewState createState() => _AusrustungViewState();
}
